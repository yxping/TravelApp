...
public class MListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setText(R.string.mlistview_footer_hint_ready);
		} else if (state == STATE_LOADING) {
			mProgressBar.setVisibility(View.VISIBLE);
		} else {
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.mlistview_footer_hint_normal);
		}
	}
	...
	private void initView(Context context) {
		...
		mContentView = moreView.findViewById(R.id.mlistview_footer_content);
		mProgressBar = moreView.findViewById(R.id.mlistview_footer_progressbar);
		mHintView = (TextView)moreView.findViewById(R.id.mlistview_footer_hint_textview);
	}
